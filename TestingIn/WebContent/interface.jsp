...
<body style ="background: LightSkyBlue" >
	<form>
		<fieldset>
			<h2> Testing Group </h2>
			<hr />
			<label  style = "margin-right:162px" >Class Name : </label><br>
			<select id="class" onchange = "getSelectedClass();" style = "width:125px;">
			...
			<select id="func" style="display:none" onchange="getSelectedFunc();">
